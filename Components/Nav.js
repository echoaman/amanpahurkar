...
export default function Nav() {
	...
	return (
		<>
			<nav className={`${styles.nav} ${navVisible ? "" : styles.nav_hide}`} id="nav">
				<div className={`${styles.nav_container}`}>
					<a href="https://linkedin.com/in/amanpahurkar/" target="_blank" rel="noopener noreferrer">
						<button className={`${styles.link_button} ${styles.linkedin}`}>
					...
					<a href="mailto:aman.pahurkar@spit.ac.in" target="_blank" rel="noopener noreferrer">
						<button className={`${styles.link_button} ${styles.mail}`}>
					...
					<a href="https://github.com/echoaman" target="_blank" rel="noopener noreferrer">
						<button className={`${styles.link_button} ${styles.github}`}>
			...
			<section className={`${styles.nav_controller}`}>
				<button className={`${styles.hamburger}`} onClick={() => updateHamburger()} id="hamburger">&lt;Aman /&gt;</button>
				<Link href="/">
